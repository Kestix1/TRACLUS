...
data2 <- tc_trajectories(data2, traj_id = "traj_id",
                       x = "x", y = "y", coord_type = "geographic", method = "projected")
tc_plot(data2)
tc_leaflet(data2)
...
tc_plot(rep2, show_clusters = TRUE)
tc_leaflet(rep2, show_clusters = FALSE)


test <- tc_traclus(data2, eps = 1500, min_lns = 2, gamma = 1, )
tc_leaflet(test, show_clusters = FALSE)
