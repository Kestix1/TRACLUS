...
cat(sprintf("eps=15: %d cluster(s), %.0f%% noise\n",
            clust_tight$n_clusters, clust_tight$noise_ratio * 100))
cat(sprintf("eps=25: %d cluster(s), %.0f%% noise\n",
            clust_medium$n_clusters, clust_medium$noise_ratio * 100))
cat(sprintf("eps=40: %d cluster(s), %.0f%% noise\n",
            clust_wide$n_clusters, clust_wide$noise_ratio * 100))
```
